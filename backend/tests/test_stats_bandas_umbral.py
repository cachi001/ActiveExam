...
BUG que clavan estos tests: las bandas eran fijas (0-24 / 25-49 / 50-69 / 70-100)
...
def test_umbral_70_conserva_las_bandas_historicas() -> None:
    ...
    assert bandas_de_score(70) == ["0-24", "25-49", "50-69", "70-100"]
...
def test_umbral_80_estira_la_banda_previa_y_la_de_riesgo_arranca_en_80() -> None:
    ...
    assert bandas_de_score(80) == ["0-24", "25-49", "50-79", "80-100"]


def test_umbral_90_idem() -> None:
    assert bandas_de_score(90) == ["0-24", "25-49", "50-89", "90-100"]
...
def test_umbral_bajo_no_genera_bandas_vacias_ni_invertidas() -> None:
    ...
    assert bandas_de_score(25) == ["0-24", "25-100"]
    assert bandas_de_score(40) == ["0-24", "25-39", "40-100"]
...
def test_score_cae_en_la_banda_correcta_con_umbral_80() -> None:
    ...
    assert banda_de_score(75, bandas) == "50-79"
    assert banda_de_score(85, bandas) == "80-100"


def test_bordes_de_banda_son_inclusivos() -> None:
    bandas = bandas_de_score(70)
    assert banda_de_score(0, bandas) == "0-24"
    assert banda_de_score(24, bandas) == "0-24"
    assert banda_de_score(25, bandas) == "25-49"
    assert banda_de_score(69, bandas) == "50-69"
