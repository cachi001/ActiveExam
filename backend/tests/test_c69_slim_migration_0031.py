"""Test de la migración 0031 slim (C-69, opción B): pool de preguntas seleccionables.

Verifica con alembic REAL contra Postgres (postgres:16, sin TimescaleDB):
- `alembic upgrade slim@head` aplica hasta 0031: pregunta_examen gana la columna
...
- `downgrade slim@0030` dropea la columna, dejando intacto pregunta_examen.
