"""Test de la migración 0028 slim (C-69 sección 6, D11).

Verifica con alembic REAL contra Postgres (postgres:16, sin TimescaleDB):
- `alembic upgrade slim@head` aplica hasta 0028: crea materia y comision.
...
- `downgrade slim@0027` dropea materia/comision y la FK, dejando examen_contenido.
