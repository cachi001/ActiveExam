"""Test de la migración 0034 slim (C-69): flags chat_habilitado / pausas_habilitadas.

Verifica con alembic REAL contra Postgres (postgres:16, sin TimescaleDB):
- `alembic upgrade slim@head` aplica hasta 0034: configuracion_sistema gana las 2
...
- `downgrade slim@0033` dropea las 2 columnas, dejando intacta configuracion_sistema.
