...
un evento critico y escalar a un coordinador humano; SHALL NO abortar el examen ni
...
class VeredictoIntento(str, Enum):
    ...
    ESCALAR_A_COORDINADOR = "escalar_a_coordinador"  # se agotaron: evento critico + escalacion
...
class EstadoVerificacion:
    ...
    def registrar_intento(self, *, exito: bool) -> tuple[EstadoVerificacion, VeredictoIntento]:
        ...
        - fallo que agota los intentos -> ESCALAR_A_COORDINADOR (estado cerrado):
        ...
        if fallidos >= MAX_INTENTOS:
            return (
                ...
                VeredictoIntento.ESCALAR_A_COORDINADOR,
            )
        return (
