"""0040 - seed recarga_pagina y reanudacion_tardia en evento_score_config (rama activeexam).

Revision ID: 0040
Revises: 0039 (branch activeexam)
...
ROLLBACK:
  alembic downgrade activeexam@0039 -> DELETE de esas dos filas (paso 2 destructivo).

VERIFICACION:
  alembic upgrade activeexam@head -> aplica hasta 0040.
