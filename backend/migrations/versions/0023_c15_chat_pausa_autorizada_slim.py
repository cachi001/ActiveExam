"""0023 - chat bidireccional + pausa autorizada (slim, C-15 tareas 6.x).
...
PROPOSITO:
  C-15 backend slim (chat proctor<->alumno + flujo de pausa autorizada). El slim
...
ROLLBACK:
  alembic downgrade slim@0022 -> dropea ambas tablas (y sus datos). No destructivo
