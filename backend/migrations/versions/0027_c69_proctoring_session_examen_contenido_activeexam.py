"""0027 - vinculo proctoring_session ↔ examen_contenido (activeexam, C-69).
...
PROPÓSITO:
  ...
  ¿Por qué en proctoring_session y no en `examen`? En la rama activeexam la tabla `examen`
...
ROLLBACK:
  alembic downgrade activeexam@0026 → dropea índice, FK y columna (en ese orden). No toca
