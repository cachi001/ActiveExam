"""0029 - write-back de nota a Moodle + respuestas del alumno (activeexam, C-69 sección 7, D10).
...
ROLLBACK:
  alembic downgrade activeexam@0028 → dropea las 3 tablas nuevas. No toca ninguna
