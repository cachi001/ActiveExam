"""0042 - moodle_component por examen + en el estado de writeback (rama activeexam, C-73).

Revision ID: 0042
Revises: 0041 (branch activeexam)
...
ROLLBACK:
  alembic downgrade activeexam@0041 -> DROP COLUMN moodle_component en ambas tablas.

VERIFICACION:
  alembic upgrade activeexam@head -> aplica hasta 0042.
