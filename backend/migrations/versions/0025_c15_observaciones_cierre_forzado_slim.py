"""0025 - observaciones del proctor + cierre forzado de sesion (slim, C-15 tareas 3.2/3.3).
...
PROPOSITO:
  ...
  propia fila (el slim no tiene tabla audit_log persistente).

ROLLBACK:
  alembic downgrade slim@0024 -> dropea las 3 columnas y la tabla observacion_proctor
