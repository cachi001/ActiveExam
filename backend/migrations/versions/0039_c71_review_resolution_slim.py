"""039 - modelo de decision de dos fases + estado de resolucion (slim, c-71
slice 2).
...
PROPOSITO:
  ...
  (c-16) a dos fases:
    ...
    Fase 1 -- REVISION (columnas `decision*` ya existentes, migracion 0013):
      ...
      Produccion slim tiene ~0 filas con decision seteada (c-16 recien
...
ROLLBACK:
  alembic downgrade slim@0038 -> dropea las 4 columnas `resolucion*` y
...
VERIFICACION:
  alembic upgrade slim@head -> aplica 0038 -> 0039. Espera columnas
