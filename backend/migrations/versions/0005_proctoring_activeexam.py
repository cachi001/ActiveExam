"""005 - tablas del modulo activeexam de proctoring.

Revision ID: 0005
Revises: (ninguna — branch independiente)
Create Date: 2026-06-02

Branch: activeexam (independiente del branch default de produccion)
  - NO depende de 0001 (TimescaleDB) ni de 0002 (hypertable, trigger, ENUM nativo).
  - Se corre con: alembic upgrade activeexam@head
  - El Dockerfile.activeexam usa este comando explicitamente.

Scope (C-45, proctoring-activeexam):
