"""0022 - detectores_activos por defecto = TODOS los detectores (activeexam).

Revises: 0021 (rama activeexam)
Create Date: 2026-06-22

RAMA: activeexam (alineado con el stack de Railway y dev). Para la rama full, agregar una
