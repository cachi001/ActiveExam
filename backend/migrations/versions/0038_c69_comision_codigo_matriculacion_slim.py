"""0038 - código de matriculación único por comisión (slim, C-70).
...
MIGRACIÓN ADITIVA EN DOS PASOS (destructive-in-two-steps aplicado a unicidad):
  ...
  No reescribe otras tablas (patrón slim).

ROLLBACK:
  ``downgrade slim@0037`` dropea el constraint UNIQUE y la columna. No toca otras
