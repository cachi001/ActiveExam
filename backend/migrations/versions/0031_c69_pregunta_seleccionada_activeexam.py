"""0031 - pool de preguntas: pregunta_examen.seleccionada (activeexam, C-69, opción B).
...
ROLLBACK:
  alembic downgrade activeexam@0030 → dropea la columna. No toca ninguna otra tabla ni
  columna (aditivo).
"""
