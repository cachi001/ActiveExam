"""0030 - destino de write-back por examen: moodle_courseid/cmid (slim, C-69, D12).
...
PROPÓSITO (D12 — parte B):
  ...
  moodle_courseid / moodle_cmid. Los valores globales de config_slim quedan
...
ROLLBACK:
  alembic downgrade slim@0029 → dropea ambas columnas. No toca ninguna otra
