"""018 - tabla consent_texto_version (rama activeexam, texto versionado Ley 25.326).

Revision ID: 0018
Revises: 0016 (rama activeexam)
...
PROPOSITO:
  ...
  Esta migracion es ACTIVEEXAM (solo crea la estructura). El seed de v1 va en 0019.
...
ROLLBACK:
  alembic downgrade activeexam@0016 -> dropea la tabla (destructivo, paso 2 separado).

VERIFICACION:
  alembic upgrade activeexam@head -> aplica 0016 -> 0018 -> 0019.
