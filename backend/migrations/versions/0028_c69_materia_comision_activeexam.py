"""0028 - materia + comisión + FK examen_contenido→comisión (activeexam, C-69 sección 6, D11).
...
ROLLBACK:
  alembic downgrade activeexam@0027 → dropea la FK examen→comisión, luego comision y
