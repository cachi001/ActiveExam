"""013 - persistencia de la decision del revisor en proctoring_session (activeexam, c-16).
...
PROPOSITO:
  c-16 backend activeexam: hoy las decisiones del revisor (descartar/escalar/derivar/
...
ROLLBACK:
  alembic downgrade activeexam@0012  -> dropea las 4 columnas. Datos persistidos
  en estas columnas se PIERDEN al downgrade — documentado en design.

VERIFICACION:
  alembic upgrade activeexam@head    -> aplica 0012 -> 0013. Espera columnas
