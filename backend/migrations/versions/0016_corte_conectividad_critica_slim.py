"""016 - seed corte_conectividad_prolongado como evento critico (rama slim).

Revision ID: 0016
Revises: 0014 (branch slim)
...
ROLLBACK:
  alembic downgrade slim@0014 -> DELETE de esa fila (paso 2 destructivo separado).

VERIFICACION:
  alembic upgrade slim@head -> aplica 0014 -> 0016.
