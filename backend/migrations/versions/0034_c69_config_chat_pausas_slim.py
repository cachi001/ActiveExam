"""0034 - flags chat_habilitado / pausas_habilitadas en configuracion_sistema (slim, C-69).
...
ROLLBACK:
  alembic downgrade slim@0033 → dropea las 2 columnas. No toca ninguna otra tabla
  ni columna (aditivo).
"""
