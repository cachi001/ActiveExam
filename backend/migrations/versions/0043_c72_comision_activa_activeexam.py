"""0043 - comision.activa (rama activeexam, C-72 seccion 17 a nivel comision).

Revision ID: 0043
Revises: 0042 (branch activeexam)
...
ROLLBACK:
  alembic downgrade activeexam@0042 -> DROP COLUMN activa.

VERIFICACION:
  alembic upgrade activeexam@head -> aplica hasta 0043.
