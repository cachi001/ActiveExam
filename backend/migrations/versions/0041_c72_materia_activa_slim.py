"""0041 - materia.activa (rama slim, C-72 seccion 17).

Revision ID: 0041
Revises: 0040 (branch slim)
...
ROLLBACK:
  alembic downgrade slim@0040 -> DROP COLUMN activa.

VERIFICACION:
  alembic upgrade slim@head -> aplica hasta 0041.
