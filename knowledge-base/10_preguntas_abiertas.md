...
| Baja | ¿Integración LMS concreta (qué LMS, LTI vs iframe vs flujo coordinado)? **Resolución propuesta: LTI 1.3 universal (DD-20), materializada en `C-49`.** Resta confirmar AGS/NRPS por LMS objetivo y si se suma un plugin Moodle nativo además del LTI. | Fase 2 | TI + dirección académica |
