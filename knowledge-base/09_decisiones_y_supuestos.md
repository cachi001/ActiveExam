...
### DD-20 (Decisión de integración) — Integración con LMS: LTI 1.3 universal **+ plugin Moodle `quizaccess`** (decisión revisada 2026-06-11)
**Decisión**: la integración con el sistema de evaluación institucional (Moodle, Canvas, Blackboard, D2L, Sakai…) se hace por **dos capas complementarias** (decisión revisada el 2026-06-11, materializada en el change futuro `integracion-lms-lti` — sin número aún):
...
En ambas capas el LMS **opera el examen** (preguntas, respuestas, nota); el proctoring NO lo crea ni lo importa, se integra **alrededor**. **Se acepta el costo del doble mantenimiento** (Tool Provider LTI + plugin PHP de Moodle) y el lock-in parcial del plugin a Moodle, a cambio de la UX fluida en el LMS primario.
