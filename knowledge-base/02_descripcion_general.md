...
| LMS institucional (Moodle, Canvas, Blackboard…) | El estudiante rinde el examen ahí; el proctoring se integra alrededor **sin acoplarse a un LMS concreto** | **LTI 1.3** universal (roster vía NRPS, retorno de resultado vía AGS) — DD-20, `C-49` (Fase 2) |
