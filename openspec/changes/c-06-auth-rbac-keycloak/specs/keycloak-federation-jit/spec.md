# Spec — keycloak-federation-jit

> Capacidad de **federación de identidad y JIT provisioning**. Keycloak (OAuth2/OIDC/SAML) federa con el directorio institucional; el Usuario se crea al primer login federado (DD-09, `04` §Usuario). Su Done es: un login federado provisiona el Usuario sin seed previo.
