# Spec — incremental-risk-score

> Score incremental vía continuous aggregate de TimescaleDB (al minuto) que pondera severidad, frecuencia y persistencia, con eventos correlacionados pesando más que la suma (RN-SC-02, RN-SC-03, DD-05).
