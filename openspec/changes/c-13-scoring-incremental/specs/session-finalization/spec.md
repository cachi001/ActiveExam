# Spec — session-finalization

> Cierre de sesión (`/sessions/{id}/finish`): tarea asíncrona que consolida métricas, calcula el score final y libera la clave de sesión (RN-SC-04, Flujo 6).
