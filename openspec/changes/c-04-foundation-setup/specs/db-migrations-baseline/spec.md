# Spec — db-migrations-baseline

> Capacidad de **andamiaje de migraciones**. Configura Alembic con la convención destructiva-en-dos-pasos y deja la migración 001 (extensión TimescaleDB + esquema vacío). Su Done es: la migración 001 corre y deja la extensión lista para C-05.
