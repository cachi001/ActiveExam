# Spec — proctor-pausa-autorizada

> Flujo de **pausa autorizada** durante un examen: el estudiante solicita una pausa (ej. ir al baño), el proctor la aprueba o rechaza, y durante la ventana aprobada los eventos de proctoring se **contextualizan** (no inflan el score) sin perderse. Acción operativa, NO disciplinaria (L2.5). Implementación slim: REST + polling.
