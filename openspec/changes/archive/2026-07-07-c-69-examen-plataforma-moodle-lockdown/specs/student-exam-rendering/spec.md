# Spec — student-exam-rendering

> Experiencia de rendición del alumno en `Examen.tsx`: renderiza las preguntas reales servidas por `exam-taking-api` (reemplaza la pregunta hardcodeada) y deja de notificar al alumno cada evento de proctoring por toast. La detección y el score server-side NO cambian.
