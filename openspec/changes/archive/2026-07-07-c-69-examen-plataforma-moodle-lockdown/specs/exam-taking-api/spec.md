# Spec — exam-taking-api

> API de lectura para que el alumno rinda un examen: devuelve preguntas y opciones reales (reemplaza la pregunta hardcodeada) SIN filtrar la opción correcta. Schemas Pydantic con `extra='forbid'`.
