# Spec — realtime-handshake-auth

> Capacidad de **auth de canales de tiempo real**: handshake WS/SSE validado con JWT + revalidación periódica, más rate limiting y rutas públicas (`03`, `08`). Su Done es: un handshake sin token válido se rechaza y la conexión se corta si el token deja de ser válido.
