# Spec — outage-duration-policy

> Política por duración del corte: < 5 min sin pérdida, > 5 min evento crítico al reconectar (RN-HB-03, RN-HB-04, RN-EV-04, Flujo 5). El evento crítico es señal para el panel, NUNCA sanción (L2.5).
