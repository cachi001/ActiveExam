# Spec — student-profile-enrollment

> Pantalla de Perfil del alumno que aloja el enrollment único (consentimiento + referencia biométrica) y define el gate de "perfil completo" que habilita inscribirse/rendir.
