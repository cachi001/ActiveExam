...
> Capacidad de **emisión y validación de JWT propios (HS256)** por el backend FastAPI, con validador multi-issuer que acepta tanto tokens propios como tokens de Keycloak según `iss`/`alg`.
