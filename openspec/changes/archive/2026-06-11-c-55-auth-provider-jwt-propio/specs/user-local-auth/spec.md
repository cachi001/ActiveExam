# Spec — user-local-auth

> Capacidad de **autenticación local con usuario/contraseña**: campo `password_hash` en `UsuarioModel`, endpoint de login, hashing bcrypt, y creación mínima de usuarios con password para que el login funcione. La gestión/CRUD completo de usuarios es otro change.
