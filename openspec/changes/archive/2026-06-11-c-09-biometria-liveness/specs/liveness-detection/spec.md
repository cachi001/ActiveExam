# Spec — liveness-detection

> Liveness híbrido propio en el cliente (pasivo + 1–2 retos activos aleatorios), prerrequisito obligatorio de la verificación (RN-BIO-05, DD-18).
