# Spec — identity-match-1to1

> Comparación 1:1 por distancia coseno contra el embedding de referencia leído cifrado de la DB, con umbral conservador (RN-BIO-01/02/03).
