...
> Capacidad de **entidades transaccionales del dominio**: Usuario, Examen, Sesión, Asignación, Consentimiento, Embedding, Evidencia, Caso disciplinario, con sus atributos, cardinalidades e invariantes (`04`). Su Done es: la migración 002 crea las tablas con sus relaciones y constraints sensibles.
