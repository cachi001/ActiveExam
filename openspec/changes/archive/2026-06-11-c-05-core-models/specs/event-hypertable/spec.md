# Spec — event-hypertable

> Capacidad de **telemetría a escala**: el Evento como hypertable TimescaleDB con índices, compresión y continuous aggregates base (DD-05, `04` §Evento, SU-06). Su Done es: la hypertable existe con sus índices y políticas.
