# Spec — observability-baseline

> Capacidad de **observabilidad base desde Fase 0** (DD-12) y verificación de arranque. Monta Prometheus/Loki/Tempo/Grafana y los smoke tests de conectividad. Su Done es: el stack se observa y la conectividad DB/storage/IdP está verificada.
