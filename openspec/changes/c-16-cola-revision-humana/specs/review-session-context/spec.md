# Spec — review-session-context

> Apertura de sesión auditada (audit log con propósito declarado) con acceso al contexto completo de solo lectura: línea de tiempo, clips firmados vía URL 15 min, observaciones del proctor, re-inferencia y audit log de accesos previos (RN-RV-03, RN-RV-04, RN-CC-05).
