# profile-consent-persistence

> **CRÍTICO (gobernanza auth/privacidad).** Estas requirements implican datos sensibles bajo Ley 25.326. Requieren **aprobación humana explícita** antes de `/opsx:apply`. Atadas a c-01 (DPIA) para la clasificación formal del consentimiento como dato sensible.
