...
El panel de supervisión funcional se entregó en C-15 (slim: REST + polling, sin SSE). Su transporte de tiempo real de producción vive en **c-15b** (bloqueado por C-03). Este change **no toca transporte** ni depende de C-03: rediseña el **modelo de roles** que gobierna el panel y la **UX** de tres pantallas.
