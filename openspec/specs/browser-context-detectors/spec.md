# browser-context-detectors

## Purpose

Define el conjunto de detectores de contexto del navegador (monitores adicionales, foco de ventana, pestañas, pantalla completa, portapapeles) que alimentan al pipeline de detección como señales. Diseñado bajo abstracción inyectable para que el flujo de examen y el harness de testeo compartan la misma implementación, sin valores hardcodeados.
## Requirements
