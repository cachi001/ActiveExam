    ...
    <StaffShell nav={ADMIN_NAV} title="Reportes y analítica" subtitle={REPORTES_SUBTITULO} help={REPORTES_AYUDA}>
      <div className="space-y-lg animate-in fade-in duration-500">
        <div className="grid sm:grid-cols-2 xl:grid-cols-4 gap-md">
          <StatCard icon="assignment" label="Exámenes" value={r.examenes_totales} sub="este cuatrimestre" tono="primary" />
          <StatCard icon="groups" label="Sesiones" value={r.sesiones_totales} sub="supervisadas" tono="info" />
